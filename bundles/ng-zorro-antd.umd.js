(function (global, factory) {
...
}(this, (function (exports,affix,alert,anchor,autoComplete,avatar,backTop,badge,breadcrumb,button,calendar,card,carousel,cascader,checkbox,collapse,comment,core,datePicker,descriptions,divider,drawer,dropdown,empty,form,grid,i18n,icon,input,inputNumber,layout,list,mention,menu,message,modal,notification,pageHeader,pagination,popconfirm,popover,progress,radio,rate,select,skeleton,slider,spin,statistic,steps,_switch,table,tabs,tag,timePicker,timeline,tooltip,transfer,tree,treeSelect,upload,core$1) { 'use strict';
     ...
     */
    /** @type {?} */
    var VERSION = new core$1.Version('7.5.0');
    ...
    exports.NZ_CAROUSEL_CUSTOM_STRATEGIES = carousel.NZ_CAROUSEL_CUSTOM_STRATEGIES;
    exports.NzCarouselBaseStrategy = carousel.NzCarouselBaseStrategy;
    ...
    exports.Breakpoint = core.Breakpoint;
    exports.responsiveMap = core.responsiveMap;
    ...
    exports.NzDescriptionsModule = descriptions.NzDescriptionsModule;
    exports.NzDescriptionsComponent = descriptions.NzDescriptionsComponent;
    exports.NzDescriptionsItemComponent = descriptions.NzDescriptionsItemComponent;
