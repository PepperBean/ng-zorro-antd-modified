...
/**
     ...
     */
throw function n(t){return TypeError("[NG-ZORRO]: useDefaultContent expect 'string', 'templateRef' or 'component' but get "+t)}(t);this.userDefaultContent$.next(t)},D.prototype.resetDefault=function(){this.userDefaultContent$.next(undefined)},D.decorators=[{type:i.Injectable,args:[{providedIn:"root"}]}],D.ctorParameters=function(){return[{type:i.Type,decorators:[{type:i.Inject,args:[c]},{type:i.Optional}]}]},D.ngInjectableDef=i.defineInjectable({factory:function(){return new D(i.inject(c,8))},token:D,providedIn:"root"}),D);function D(t){this.defaultEmptyContent=t,this.userDefaultContent$=new I.BehaviorSubject(undefined),this.defaultEmptyContent&&this.userDefaultContent$.next(this.defaultEmptyContent)}var C=(y.prototype.ngOnChanges=function(t){t.nzComponentName&&(this.size=this.getEmptySize(t.nzComponentName.currentValue)),t.specificContent&&!t.specificContent.isFirstChange()&&(this.content=t.specificContent.currentValue,this.renderEmpty())},y.prototype.ngOnInit=function(){var n=this,t=this.emptyService.userDefaultContent$.subscribe(function(t){n.content=n.specificContent||t,n.renderEmpty()});this.subs_.add(t)},y.prototype.ngOnDestroy=function(){this.subs_.unsubscribe()},y.prototype.getEmptySize=function(t){switch(t){case"table":case"list":return"normal";case"select":case"tree-select":case"cascader":case"transfer":return"small";default:return""}},y.prototype.renderEmpty=function(){var t=this.content;if("string"==typeof t)this.contentType="string";else if(t instanceof i.TemplateRef){var n={$implicit:this.nzComponentName};this.contentType="template",this.contentPortal=new g.TemplatePortal(t,this.viewContainerRef,n)}else if(t instanceof i.Type){n=new WeakMap([[a,this.nzComponentName]]);var e=new g.PortalInjector(this.injector,n);this.contentType="component",this.contentPortal=new g.ComponentPortal(t,this.viewContainerRef,e)}else this.contentType="string",this.contentPortal=undefined;this.cdr.markForCheck()},y.decorators=[{type:i.Component,args:[{changeDetection:i.ChangeDetectionStrategy.OnPush,encapsulation:i.ViewEncapsulation.None,selector:"nz-embed-empty",exportAs:"nzEmbedEmpty",template:'<ng-container *ngIf="!content && specificContent !== null" [ngSwitch]="size">\r\n  <nz-empty *ngSwitchCase="\'normal\'" class="ant-empty-normal" [nzNotFoundImage]="defaultSvg"></nz-empty>\r\n  <nz-empty *ngSwitchCase="\'small\'" class="ant-empty-small" [nzNotFoundImage]="defaultSvg"></nz-empty>\r\n  <nz-empty *ngSwitchDefault></nz-empty>\r\n</ng-container>\r\n<ng-container *ngIf="content">\r\n  <ng-template *ngIf="contentType !== \'string\'" [cdkPortalOutlet]="contentPortal"></ng-template>\r\n  <ng-container *ngIf="contentType === \'string\'">\r\n    {{ content }}\r\n  </ng-container>\r\n</ng-container>\r\n'}]}],y.ctorParameters=function(){return[{type:u},{type:n.DomSanitizer},{type:i.ViewContainerRef},{type:i.ChangeDetectorRef},{type:i.Injector}]},y.propDecorators={nzComponentName:[{type:i.Input}],specificContent:[{type:i.Input}]},y);function y(t,n,e,g,o){this.emptyService=t,this.sanitizer=n,this.viewContainerRef=e,this.cdr=g,this.injector=o,this.contentType="string",this.defaultSvg=this.sanitizer.bypassSecurityTrustResourceUrl(s),this.size="",this.subs_=new I.Subscription}var A=(Object.defineProperty(z.prototype,"shouldRenderContent",{get:function(){var t=this.nzNotFoundContent;return!(!t&&"string"!=typeof t)},enumerable:!0,configurable:!0}),z.prototype.ngOnChanges=function(t){var n=t.nzNotFoundContent;n&&(this.isContentString="string"==typeof n.currentValue)},z.prototype.ngOnInit=function(){var t=this;this.i18n.localeChange.pipe(e.takeUntil(this.destroy$)).subscribe(function(){t.locale=t.i18n.getLocaleData("Empty"),t.cdr.markForCheck()})},z.prototype.ngOnDestroy=function(){this.destroy$.next(),this.destroy$.complete()},z.decorators=[{type:i.Component,args:[{changeDetection:i.ChangeDetectionStrategy.OnPush,encapsulation:i.ViewEncapsulation.None,selector:"nz-empty",exportAs:"nzEmpty",template:'<div class="ant-empty-image">\r\n  <ng-container *nzStringTemplateOutlet="nzNotFoundImage">\r\n    <img [src]="nzNotFoundImage || defaultSvg" [alt]="isContentString ? nzNotFoundContent : \'empty\'">\r\n  </ng-container>\r\n</div>\r\n<p class="ant-empty-description">\r\n  <ng-container *nzStringTemplateOutlet="nzNotFoundContent">\r\n    {{ shouldRenderContent ? nzNotFoundContent : locale[\'description\'] }}\r\n  </ng-container>\r\n</p>\r\n<div class="ant-empty-footer" *ngIf="nzNotFoundFooter">\r\n  <ng-container *nzStringTemplateOutlet="nzNotFoundFooter">\r\n    {{ nzNotFoundFooter }}\r\n  </ng-container>\r\n</div>\r\n',host:{"class":"ant-empty"},styles:["nz-empty { display: block; }"]}]}],z.ctorParameters=function(){return[{type:n.DomSanitizer},{type:r.NzI18nService},{type:i.ChangeDetectorRef}]},z.propDecorators={nzNotFoundImage:[{type:i.Input}],nzNotFoundContent:[{type:i.Input}],nzNotFoundFooter:[{type:i.Input}]},z);function z(t,n,e){this.sanitizer=t,this.i18n=n,this.cdr=e,this.defaultSvg=this.sanitizer.bypassSecurityTrustResourceUrl(N),this.isContentString=!1,this.locale={},this.destroy$=new I.Subject}var j=(p.decorators=[{type:i.NgModule,args:[{imports:[o.CommonModule,g.PortalModule,M.NzAddOnModule,r.NzI18nModule],declarations:[A,C],exports:[A,C]}]}],p);function p(){}t.NzEmbedEmptyComponent=C,t.NzEmptyComponent=A,t.NzEmptyModule=j,t.NzEmptyService=u,t.NZ_DEFAULT_EMPTY_CONTENT=c,t.NZ_EMPTY_COMPONENT_NAME=a,t.emptyImage=N,t.simpleEmptyImage=s,Object.defineProperty(t,"__esModule",{value:!0})});
